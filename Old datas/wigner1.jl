...
"""
    Visualization of Wigner Function
"""
# Example Parameters
rho = [1 0 0 1]' * [1 0 0 1]  # Example 2x2 density matrix
rho /= tr(rho)
xvec = range(-5, 5, length=100)  # x-coordinates
yvec = range(-5, 5, length=100)  # y-coordinates

# Compute the Wigner function
W = wigner_clenshaw(rho, xvec, yvec, sqrt(2), false)
